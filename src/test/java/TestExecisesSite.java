...
public class TestExecisesSite extends TestBaseClass {
    @Test
    public void test01() {
        //1. Launch browser
        ...
        driver.findElement(By.xpath("//input[@data-qa='signup-name']")).sendKeys("Erkam");
        driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("erkamdeneme1903@gmail.com");
